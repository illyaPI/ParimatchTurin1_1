...
import com.faparimat.mach.com.BuildConfig
import com.faparimat.mach.com.R
import com.faparimat.mach.com.databinding.ActivityWebViewTurinBinding
import com.faparimat.mach.com.diturin.webviewturin.CustomWebViewClientTurin
...
import com.faparimat.mach.com.importantturin.modelsturin.AFStatusTurin
import com.faparimat.mach.com.repositoryturin.viewbindingturin.ViewBindingActivityTurin
import com.faparimat.mach.com.servicesturin.InternetCheckerServiceTurin
import com.faparimat.mach.com.servicesturin.utilturin.checkForPermissionsTurin
import com.faparimat.mach.com.servicesturin.utilturin.decodeFromBase64Turin
import java.io.File
import java.text.SimpleDateFormat
import java.util.*
import javax.inject.Inject

class WebViewActivityTurin : ViewBindingActivityTurin<ActivityWebViewTurinBinding>(ActivityWebViewTurinBinding::inflate) {
  ...
  private fun setupBinomLinkTurin() {
    ...
    if (blackBaseTurin != null) {
      ...
      if (binomLinkTurin != null) {
        ...
        val sub10Turin = "${applicationTurin.appsFlyerIdTurin}||${applicationTurin.googleAdvertisingIdTurin}||${BuildConfig.APPS_FLYER_KEY_TURIN.decodeFromBase64Turin()}"
        builtBinomLinkTurin = "$blackBaseTurin?key=$defaultKeyTurin&bundle=${BuildConfig.APPLICATION_ID}&sub7=Organic&sub10=$sub10Turin"
      }
  ...
  companion object {
    ...
    private const val TAG_TURIN: String = "WebViewActivityTurin"
  }
}